...
{   
    ...
    scanf("%d", &n);                                      // Ввод кол-ва данных
    printf("\nВведите минимальное значение (n>0): ");
    scanf("%d", &MIN_VALUE);                              // Ввод минимального значения данных
    printf("\nВведите максимальное значение (n>0): ");
    scanf("%d", &MAX_VALUE);                              // Ввод максимального значения данных
